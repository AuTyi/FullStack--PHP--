...
$all_entries = $conn->query("SELECT * FROM blog_blog ORDER BY date desc" . $selection); //select all ;
$entries = $conn->query("SELECT * FROM blog_blog ORDER BY date desc" . $selection . 
